...
## Login to system and create super-user

**Description**

- System shall log a user to dashboard, if email and password provided to the system can be validated.

**Inputs**

- Email - Must be in structure someName@gmail.com, @gmail.com must exist
